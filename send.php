  ...
  <?php include('user-logout.php'); ?>
	<section class="pb-3">
		<div class="container">
            <div class="row">
                <div class="col-md-6 offset-sm-3">
                    <button type="button" data-toggle="modal" data-target="#sendmail" name="sendmail" class="btn btn-success btn-lg w-100 mb-4">Send Invoice on Mail</button>
                    <a href="https://www.messenger.com/" target="_blank" name="sendmassenger" class="btn btn-success btn-lg w-100 mb-4">Send Invoice on Messenger</a>
                    <a href="https://www.whatsapp.com/" target="_blank" name="sendwhatsapp" class="btn btn-success btn-lg w-100 mb-4">Send Invoice on Whatsapp</a>
